...
class _EditDiscountScreenState extends State<EditDiscountScreen> {
  ...
  void initState() {
    super.initState();
    _monthController = TextEditingController(text: widget.discount.month);
    _amountController = TextEditingController(text: widget.discount.amount.toString());
    _noteController = TextEditingController(text: widget.discount.notes ?? '');
    _selectedMonth = _tryParseMonth(widget.discount.month);
  }
  ...
  Future<void> _update() async {
    ...
    try {
      ...
      final ok = await _firebaseService.updateDiscount(updated);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: const Text('Edit Discount')),
